...
function dgo(n, comp) {
    ...
    onoff(idx, cur);
    cur = idx;
    p.stop().animate({ left: -1 * imgWidth * n }, { duration: dur, complete: comp });
...
// var pn_btn = $('<s class="prev" display="none"><i></i></s><s class="next" display="none"><i></i></s>');
$('<div class="btns"/ >')
    .append(
        $('<b/>')
            .append(btns)
